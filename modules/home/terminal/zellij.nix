...
let
  ...
  # upstream v0.3.0 source reproducibly for wasm32-wasip1 instead.
  #
  # This follows nixpkgs' documented Rust cross-compilation pattern for
  # Zellij Harpoon.
  harpoonPlugin =
    pkgsUnstable.pkgsCross.wasm32-wasip1.callPackage
      (
        ...
        rustPlatform.buildRustPackage {
          ...
          # Cross-compiled WASM cannot be executed as a native test binary.
          doCheck = false;

          # Expose one stable, unambiguous plugin artifact to Home Manager.
          installPhase = ''
            runHook preInstall
      ...
      extraConfig = ''
        ...
        keybinds {
          ...
          shared_except "locked" {
            // Harpoon: quickly access a hand-picked list of panes.
            // Alt+p = pinned panes.
            bind "Alt p" {
            ...
            // Fuzzy-search and switch between tabs.
            //
            // quick_jump stays disabled because numeric tab names are useful
            // for project IDs, CVEs, IP-related work and similar workflows.
            bind "Alt r" {
